...
function App() {
  ...
  const [findedMoviesFilteredByToggle, setFindedMoviesFilteredByToggle] =
    useState([]);
  ...
  const searchMovies = async (queryText, isShortFilmToggle) => {
    ...
    const filteredMoviesWithToggle = filterMovies(
      filteredMovies,
      queryText,
      isShortFilmToggle
    );
  ...
  const removeMovie = async (id) => {
    try {
      ...
      setSavedMovies((movies) => [
        ...movies.filter((mov) => mov.movieId !== id),
      ]);
        ...
        {appLoading ? (
          ...
          <>
            ...
            <Routes>
              ...
              <Route
                element={
                  <ConditionalRoutes condition={loggedIn} redirectPath="/" />
                }
              >
                <Route
                  path="/profile"
                ...
                <Route
                  ...
                  element={
                    <Movies
                      ...
                      hasLoadMore={
                        shownFindedMovies.length ===
                        findedMoviesFilteredByToggle.length
                      }
                ...
                <Route
                  ...
                  element={
                    <SavedMovies
                      movies={filteredSavedMovies.map((movie) => ({
                        ...movie,
                        type: "remove",
                      }))}
                      onRemoveMovie={removeMovie}
            ...
            <div
              className={`error-popup ${
                popupErrorOpen && "error-popup_visible"
              }`}
            >
              {popupErrorMessage}
            </div>
